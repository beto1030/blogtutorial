    ...
    include_once(__DIR__.'/productionData/connect.php');
                       ...
                       <div class="col">
                           <div class="card">
                                 ...
                                 <div class="card-body">
                                       ...
                                       <p class="card-text"> <?= $arr[$i]['summary'] ?> </p>
                                       <p class="card-text"><small class="text-muted"><?= $formatedDate ?></small></p>
                                       <a href="post/index.php?post=<?php echo $arr[$i]['slug']['current']; ?>" class="btn btn-primary">View Post</a>
                                 </div>
                           </div>
                       </div>
